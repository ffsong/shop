<template>
  <div class="container">
    <!-- 添加成功提示 -->
    <div v-if="newShoppingCart" class="add-info-box-container">
        ...
        <div class="add-info-detail">
          ...
          <div class="add-info-box-row">
            <div class="add-info-img">
              <img src="http://img10.360buyimg.com/cms/s60x60_jfs/t28834/286/1327928640/227342/e6558c29/5cdd0695Nb1405cc3.jpg" alt="">
            </div>
            <div class="add-info-intro">
              <p>苹果8/7手机壳iPhone7 Plus保护壳全包防摔磨砂硬外壳 4.7英寸-深邃蓝...</p>
